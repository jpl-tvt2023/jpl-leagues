    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8 backdrop-blur">
        ...
        <ul className="space-y-3 text-gray-300 text-sm sm:text-base">
          ...
          {primary ? (
            <RuleItem>Teams are <strong className="text-white">ranked each GW</strong> by their squad score. This tier has <strong className="text-white">no GW payouts</strong> — ranking only affects standings.</RuleItem>
          ) : (
            <>
