...
export default function LeagueHelpPage() {
  ...
  const variantLabel = leagueFormat === "triple-crown" ? "Triple Crown" : teamSize === 8 ? "8-Team" : teamSize === 16 ? "16-Team" : "32-Team";
  ...
  // --- TRIPLE CROWN FAQ & SCENARIO CONTENT ---
  ...
  const tcTeamScenarios = userRole !== "public"
    ? [
        {
          number: 4,
  ...
  const allFaqs = isTripleCrown
    ? [...tcGeneralFaqs, ...(userRole !== "public" ? tcTeamFaqs : [])]
    : [...generalFaqs, ...(userRole !== "public" ? teamFaqs : [])];

  const allScenarios = isTripleCrown
    ? [...tcPublicScenarios, ...tcTeamScenarios]
    : [...publicScenarios, ...teamScenarios];
