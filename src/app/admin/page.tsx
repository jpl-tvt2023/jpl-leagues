    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 py-6 sm:py-10">
        <div className="mb-6 sm:mb-10">
          ...
          <p className="text-sm sm:text-base text-gray-400 mt-1">Select a league to manage</p>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {leagues.map((league) => (
              <Link
                ...
                className="group block rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6 backdrop-blur hover:border-yellow-500/50 hover:bg-white/10 transition-all duration-200"
              >
